...
export default function Layout({children}) {
    return <div>
        <Head>
            ...
            <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@500&family=Prompt:ital,wght@0,300;0,400;0,700;1,100;1,400&display=swap" rel="stylesheet"/>
            <title>{name}</title>
            <meta
                name="description"
